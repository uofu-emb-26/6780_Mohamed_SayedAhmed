...
extern volatile int16_t motor_speed;       // Measured motor speed in encoder counts/sample
extern volatile uint16_t adc_value;        // ADC measured motor current
...
// Logging helpers for RTT graphing
void log_init(void);
void log_data(void);
